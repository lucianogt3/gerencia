...
{% block sidebar %}
  <a class="nav-link active" href="{{ url_for('manager.dashboard') }}">Status Painel</a>
...
{% block sidebar %}
  <a class="nav-link" href="{{ url_for('manager.dashboard') }}">Status Painel</a>
...
{% block sidebar %}
  <a class="nav-link active" href="{{ url_for('nurse.dashboard') }}">Status Painel</a>
...
{% block sidebar %}
  <a class="nav-link" href="{{ url_for('nurse.dashboard') }}">Status Painel</a>
